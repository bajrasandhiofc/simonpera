    ...
    <div class="container-fluid d-flex flex-wrap justify-content-around py-3">
        <div class="card m-3" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <a href="./tiket.php" class="btn btn-primary">Pesan Sekarang</a>
            </div>
        </div>
        ...
        <div class="card m-3" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="./prewedding.php" class="btn btn-primary">Pesan Sekarang</a>
            </div>
        </div>
        ...
        <div class="card m-3" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="./lapangan.php" class="btn btn-primary">Pesan Sekarang</a>
            </div>
        </div>
        ...
        <div class="card m-3" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="./rapat.php" class="btn btn-primary">Pesan Sekarang</a>
            </div>
        </div>
        ...
        <div class="card m-3" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="./guide.php" class="btn btn-primary">Pesan Sekarang</a>
            </div>
        </div>
    </div>
